...
class MenuItemVariant {
     ...
     */
    static async update(id, { name, price, is_active }, tenantId) {
        if (!tenantId) {
        ...
        const values = [name, price, is_active, id, tenantId];
        const { rows } = await db.query(query, values);
