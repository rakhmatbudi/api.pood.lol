...
class MenuItem {
    ...
    static async update(id, menuItemData) {
        const { name, description, price, category_id, is_active, image_path } = menuItemData; // Now accepting image_path
        const query = `
            UPDATE menu_items
            SET
                ...
                image_path = COALESCE($6, image_path), -- Update image_path field
